// ── Dueno/Fincas/Index — Ag-Grid lista de fincas ────────────────────────────
...
const colDefs = [
    ...
    },
    {
        ...
        cellRenderer: p => `<a href="/Dueno/Fincas/${p.data.id}" class="btn btn-sm btn-outline-primary rounded-3 py-0">
...
$(document).ready(() => {
    ...
    $.get(`${API_URL_BASE}/Dueno/Fincas/Data`, (data) => {
