        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IbanCompleto = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IbanOfuscado = table.Column<string>(type: "nvarchar(24)", maxLength: 24, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParametrosPago", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParametrosPago_Sujetos_CreadoPor",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SnapshotParametrosJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParametrosPago_CreadoPor",
                table: "ParametrosPago",
                column: "CreadoPor");
